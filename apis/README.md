...
```toml
[dependencies]
qiniu-apis = { version = "0.3.0", features = ["async-std-runtime", "isahc"] }
```
...
```toml
[dependencies]
qiniu-apis = { version = "0.3.0", features = ["tokio-runtime", "isahc"] }
```
...
```toml
[dependencies]
qiniu-apis = { version = "0.3.0", features = ["tokio-runtime", "reqwest"] }
```
