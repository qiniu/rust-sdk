...
pub struct PathParams {
    r#from_url: Option<std::borrow::Cow<'static, str>>,
    r#to_entry: Option<std::borrow::Cow<'static, str>>,
...
impl PathParams {
    ...
    fn build(self) -> Vec<std::borrow::Cow<'static, str>> {
        ...
        if let Some(segment) = self.r#from_url {
            all_segments.push(segment);
        }
        if let Some(segment) = self.r#to_entry {
            all_segments.push(std::borrow::Cow::Borrowed("to"));
            all_segments.push(segment);
        }
...
impl PathParams {
    ...
    #[must_use]
    #[doc = "指定抓取的 URL"]
    pub fn set_from_url_as_str(mut self, value: impl Into<std::borrow::Cow<'static, str>>) -> Self {
        self.r#from_url = Some(qiniu_utils::base64::urlsafe(value.into().as_bytes()).into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定目标对象空间与目标对象名称"]
    pub fn set_to_entry_as_str(mut self, value: impl Into<std::borrow::Cow<'static, str>>) -> Self {
        self.r#to_entry = Some(qiniu_utils::base64::urlsafe(value.into().as_bytes()).into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定抓取 URL 请求用的 HOST 参数"]
...
impl ResponseBody {
    #[doc = "设置 抓取后保存的对象名称"]
    pub fn set_object_name_as_str(&mut self, new: String) -> Option<String> {
        self.0
            .as_object_mut()
            .unwrap()
