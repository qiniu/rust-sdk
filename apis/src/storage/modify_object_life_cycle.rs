...
impl PathParams {
    ...
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toArchiveAfterDays 转换到归档存储类型， 设置为 -1 表示取消已设置的转归档存储的生命周期规则"]
    ...
    pub fn set_to_deep_archive_after_days_as_i8(mut self, value: i8) -> Self {
    ...
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_i16(mut self, value: i16) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_i32(mut self, value: i32) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_i64(mut self, value: i64) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_isize(mut self, value: isize) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_u8(mut self, value: u8) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_u16(mut self, value: u16) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_u32(mut self, value: u32) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
    #[must_use]
    #[doc = "指定文件上传后在设置的 toDeepArchiveAfterDays 转换到深度归档存储类型， 设置为 -1 表示取消已设置的转深度归档存储的生命周期规则"]
    pub fn set_to_deep_archive_after_days_as_u64(mut self, value: u64) -> Self {
        self.r#to_deep_archive_after_days = Some(value.to_string().into());
        self
    }
    #[inline]
