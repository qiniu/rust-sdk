...
pub use client::{
    ...
    CallbackContext, Callbacks, CallbacksBuilder, Chooser, ChosenResult, Client, ClientBuilder,
    DefaultRetrier, DefaultRetrierBuilder, ExponentialRetryDelayPolicy, FixedRetryDelayPolicy,
