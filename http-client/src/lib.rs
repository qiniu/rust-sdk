...
pub use client::{
    ...
    NeverRetrier, OnDomainResolved, OnError, OnHeader, OnIPsChosen, OnProgress, OnRequest, OnRetry,
    OnStatusCode, OnSuccess, OnToChooseIPs, OnToResolveDomain, Part, PartMetadata, QueryPairKey,
    QueryPairValue, QueryPairs, RandomizedBackoff, Ratio, RequestBuilder, RequestRetrier,
    RequestRetrierOptions, ResolveAnswers, ResolveOptions, ResolveResult, Resolver, Response,
    ResponseError, ResponseErrorKind, ResponseInfo, RetriedStatsInfo, RetryDecision, RetryResult,
