...
pub use client::{
    ...
    NeverRetrier, Part, PartMetadata, QueryPairKey, QueryPairValue, QueryPairs, RandomizedBackoff,
    Ratio, RequestBuilder, RequestRetrier, RequestRetrierOptions, ResolveAnswers, ResolveOptions,
    ResolveResult, Resolver, Response, ResponseError, ResponseErrorKind, ResponseInfo,
    RetriedStatsInfo, RetryDecision, RetryResult, ShuffledChooser, ShuffledResolver,
    SimpleResolver, SimplifiedCallbackContext, SubnetChooser, SubnetChooserBuilder, SyncMultipart,
    SyncPart, SyncPartBody, SyncRequestBody, SyncRequestBuilder, SyncResponse, TimeoutResolver,
    NO_BACKOFF,
};
pub use regions::{
