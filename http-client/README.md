...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.8", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.8", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.8", features = ["async", "reqwest"] }
```
