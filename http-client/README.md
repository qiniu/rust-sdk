...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.7", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.7", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.7", features = ["async", "reqwest"] }
```
