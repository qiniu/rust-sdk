...
```toml
[dependencies]
qiniu-http-client = { version = "0.1.2", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.1.2", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.1.2", features = ["async", "reqwest"] }
```
