...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.9", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.9", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.0.9", features = ["async", "reqwest"] }
```
