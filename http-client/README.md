...
```toml
[dependencies]
qiniu-http-client = { version = "0.3.0", features = ["async_std_runtime", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.3.0", features = ["tokio_runtime", "isahc"] }
```
...
```toml
[dependencies]
qiniu-http-client = { version = "0.3.0", features = ["tokio_runtime", "reqwest"] }
```
