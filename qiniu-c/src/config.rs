...
pub extern "C" fn qiniu_ng_config_init(config: *mut qiniu_ng_config) {
    ...
    unsafe {
        ...
        (*config).upload_chunk_size = default.upload_chunk_size();
        ...
        (*config).host_freeze_duration = default.host_freeze_duration().as_secs();
    }
}
