...
pub enum qiniu_ng_invalid_upload_token_error_kind_t {
    ...
    qiniu_ng_invalid_upload_token_error_kind_base64_decode_error(qiniu_ng_string_t),
    qiniu_ng_invalid_upload_token_error_kind_json_decode_error(qiniu_ng_string_t),
}
...
pub enum qiniu_ng_err_kind_t {
    ...
    qiniu_ng_err_kind_io_error(qiniu_ng_string_t),
    qiniu_ng_err_kind_unexpected_redirect_error,
    qiniu_ng_err_kind_user_canceled,
    qiniu_ng_err_kind_json_error(qiniu_ng_string_t),
    qiniu_ng_err_kind_response_status_code_error(u16, qiniu_ng_string_t),
    qiniu_ng_err_kind_unknown_error(qiniu_ng_string_t),
    ...
    qiniu_ng_err_kind_bad_mime_type(qiniu_ng_string_t),
}
...
pub extern "C" fn qiniu_ng_err_ignore(err: &mut qiniu_ng_err_t) {
    match err.0 {
        qiniu_ng_err_kind_t::qiniu_ng_err_kind_io_error(error_description) => qiniu_ng_string_free(error_description),
        qiniu_ng_err_kind_t::qiniu_ng_err_kind_unknown_error(error_description) => {
            qiniu_ng_string_free(error_description)
        }
        qiniu_ng_err_kind_t::qiniu_ng_err_kind_json_error(error_description) => qiniu_ng_string_free(error_description),
        qiniu_ng_err_kind_t::qiniu_ng_err_kind_response_status_code_error(_, error_description) => {
            qiniu_ng_string_free(error_description)
        }
    ...
    fn from(err: &HTTPError) -> Self {
        match err.error_kind() {
            HTTPErrorKind::HTTPCallerError(e) => qiniu_ng_err_t(
                ...
                {
                    qiniu_ng_err_kind_t::qiniu_ng_err_kind_unknown_error(qiniu_ng_string_t::from_str_unchecked(
