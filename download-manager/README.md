...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.2", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.2", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.2", features = ["async", "reqwest"] }
```
