...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.0", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.0", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-download-manager = { version = "0.1.0", features = ["async", "reqwest"] }
```
