...
```toml
[dependencies]
qiniu-objects-manager = { version = "0.3.0", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-objects-manager = { version = "0.3.0", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-objects-manager = { version = "0.3.0", features = ["async", "reqwest"] }
```
