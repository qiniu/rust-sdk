...
mod tests {
    ...
    use warp::{
        filters::body::bytes, header::value as header_value, http::header::HeaderValue, path,
    ...
    async fn sync_http_test() -> anyhow::Result<()> {
        ...
        starts_with_server!(addr, routes, {
            spawn_blocking(move || {
                ...
                let mut response = SyncReqwestHTTPCaller::default().call(
                    &Request::builder()
                        .url(
    ...
    async fn async_http_test() -> anyhow::Result<()> {
        ...
        starts_with_server!(addr, routes, {
            ...
            let mut response = AsyncReqwestHTTPCaller::default()
                .async_call(
                    &Request::builder()
                        .url(
                            format!("http://{}/dir1/dir2/file", addr)
