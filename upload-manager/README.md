...
```toml
[dependencies]
qiniu-upload-manager = { version = "0.0.7", features = ["ureq"] }
```
...
```toml
[dependencies]
qiniu-upload-manager = { version = "0.0.7", features = ["async", "isahc"] }
```
...
```toml
[dependencies]
qiniu-upload-manager = { version = "0.0.7", features = ["async", "reqwest"] }
```
